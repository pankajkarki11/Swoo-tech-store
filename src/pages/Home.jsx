...
const EcommerceHomepage = () => {
  ...
  const [showDealsTimer, setShowDealsTimer] = useState(true);
    ...
    try {
      ...
      if (allCarts && allCarts.length > 0) {
        ...
        const averageCartValue =
          allCarts.length > 0 ? totalValue / allCarts.length : 0;

        setSystemStats({
          totalProducts: allProducts.length,
          totalCarts: allCarts.length,
          activeUsers: stats?.totalUsersWithCarts || 0,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30 font-sans">
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mt-16 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all hover:-translate-y-1">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Across the globe</p>
                </div>
              </div>
              <p className="text-gray-500 text-sm">
                Get your orders delivered in 2-5 business days with real-time
                tracking.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-2xl transition-all hover:-translate-y-1">
              ...
              <p className="text-gray-500 text-sm">
                Track system-wide shopping statistics and popular trends in
                real-time.
              </p>
            </div>
          </div>
        ...
        {/* Deals Banner */}
        <div className="bg-gradient-to-r from-[#FF6B6B] to-[#FF8E53] rounded-3xl p-6 md:p-8 text-white shadow-2xl">
          ...
          <div className="text-center">
            <button
              onClick={() => navigate("/products")}
              className="bg-white text-gray-900 px-8 py-3 rounded-full font-semibold hover:shadow-xl transition hover:scale-105 flex items-center gap-2 mx-auto"
            >
...
EcommerceHomepage.defaultProps = {
