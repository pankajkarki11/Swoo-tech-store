            ...
            {filteredProducts.map((product) => (
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center">
                  <div className="md:w-48 md:h-48 h-40 mb-4 md:mb-0">
                    <img
                      src={product.image}
                      alt={product.title}
                  ...
                  <div className="md:ml-6 flex-1">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-6 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition font-medium"
                      >
                        Add to Cart
                      </button>
                    </div>
