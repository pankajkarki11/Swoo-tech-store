          ...
          <div className="lg:w-1/2 w-full flex items-center justify-center p-6 md:p-8 lg:p-12">
            <div className="w-full max-w-md mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {errorMessage && (
                  <div className="mt-6 p-4 bg-red-50 text-red-800 rounded-xl border border-red-200 flex items-center">
                    <svg
          ...
          <div className="lg:w-1/2 w-full relative bg-gray-20 p-8 md:p-10 lg:p-12 flex flex-col justify-between">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-center">
                  <div className="bg-black/20 p-2 rounded-lg mr-4">
              ...
              <div className=" bg-gradient-to-br from-[#01A49E] via-[#018A85] to-[#016F6B backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            ...
            <div className="relative z-10 mt-8 pt-8 border-t border-white/20">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-black font-bold text-lg">SWOO TECH MART</p>
